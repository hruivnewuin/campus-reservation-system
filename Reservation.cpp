...
Reservation::Reservation()
    : reservationID(0), studentID(0), studnetName(""), resourceID(""), reservationDate("") {}
  
Reservation::Reservation(int resID, int studID, const std::string& studName, const std::string& resourceID, const std::string& resourceID, const std::string& data)
    : reservationID(resID), studentID(studID), studnetName(studName), resourceID(resourceID), reservationDate(date) {}
